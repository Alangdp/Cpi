...
def ranking():
    return render_template('ranking.html',
                            ...
                            klbn3_value = klbn3.Datas()['value'], klbn3_highprice = klbn3.Dy()['dy6'], klbn3_img = 'static/images/klbnlogo.png',
